...
//        controlCss(thisFunName);
    ...
    function ckxn() {
		...
		$.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getVehicleAnalysis",
			async: false,
...
//        ckxnXVal.push(steering);
        ...
        $.ajax({
            type: "POST",
            url: webPath+"/svdm/risk/getDynamicSystem",
            data: {unit_id: unit_id},
			async: false,
            success: function (data) {
                if (data != ""&&data!="[]") {
    ...
    function xslk() {
        ...
        $.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getRoadAnalysis",
            data:{unit_id:unit_id},
            async: false,
            success: function(data) {
                if(data != ""&& data!="[]"){
    ...
    function weatherkuai() {
        $.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getWeatherAnalysis",
            data:{unit_id:unit_id},
            async: false,
            success: function(data) {
                if(data != "[]"&&data!==""){
    ...
    function glnl() {
        ...
        $.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getManagement",
            data:{unit_id:unit_id},
            async: false,
            success: function(data) {
                if(data != ""&&data!="[]"){
        ...
        $.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getVehicleManagement",
            data:{unit_id:unit_id},
            async: false,
            success: function(data) {
                var json = JSON.parse(data);
...
//                sortOrder: "asc",
            ...
            url: webPath+"/svdm/risk/getDriverAnalysisDataDisplay1",
            dataType: "json",
...
//                        return time.getFullYear()+"-"+time.getMonth()+"-"+time.getDay()+" "+time.getHours()+":"+time.getMinutes()+":"+time.getSeconds();
    ...
    function getBusinessDriverActionList(){
        $.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getDriverAnalysisDataDisplay2",
            async: false,
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != ""){
...
//        count= 0;
        $.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getDriverAnalysis",
            async: false,
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != "" && data!="[]"){
                    ...
                    if(json.length>0){
                        for(var i=0;i<json.length;i++){
                            ...
                            $("#weather_warning_analysis").html(Zero(obj.weather_warning_analysis)+"%");
                            $("#speeding_early_warning_analysis").html(Zero(obj.speeding_early_warning_analysis)+"%");
                            $("#fatigue_driving_early_warning_analysis").html(Zero(obj.fatigue_driving_early_warning_analysis)+"%");
                            $("#fatigue_driving_analysis").html(Zero(obj.fatigue_driving_analysis)+"%");
                            $("#overloading_analysis").html(Zero(obj.overloading_analysis)+"%");
                            $("#overspeed_driving_analysis").html(Zero(obj.overspeed_driving_analysis)+"%");
                            $("#irregularities_carrying_human_load_analysis").html(Zero(obj.irregularities_carrying_human_load_analysis)+"%");
                            $("#high_speed_overspeed_analysis").html(Zero(obj.high_speed_overspeed_analysis)+"%");
                        }
                    }
                }else {
...
//        return count;
		$.ajax({
			type: "POST",
			url : webPath+"/svdm/risk/getOverSpeedDriving",
			async: false,
			data:{unit_id:unit_id},
			success: function (data) {
				if (data!="") {
    ...
    function getBusinessRouteEfficiencyList(){
        $.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getListRoadDataDisplay",
            async: false,
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != ""){
    ...
    function getBusinessRouteEfficiency(){
        $.ajax({
            type: "POST",
            async: false,
            url:webPath+"/search/businessUnitRisk/getBusinessRouteEfficiency",
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != ""){
                    var json = JSON.parse(data);
    ...
    function getBusinessRouteEfficiencyGraphical(){
        $.ajax({
            type: "POST",
            async: false,
            url:webPath+"/svdm/risk/getAverageElevation",
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != ""){
                    var json = JSON.parse(data);
...
//                        runningConditionTitle.push(obj.create_time_group);
    ...
    function getBusinessWeatherList(){
        $.ajax({
            type: "POST",
            async: false,
            url:webPath+"/svdm/risk/getListRoadDataDisplay2",
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != ""){
                    var json = JSON.parse(data);
    ...
    function getBusinessWeatherGraphicalAllTime(){
        $.ajax({
            type: "POST",
            async: false,
            url:webPath+"/svdm/risk/getWeatherTime",
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != ""){
                    var json = JSON.parse(data);
    ...
    function getUnitCarGpsList(){
        $.ajax({
            type: "POST",
            async: false,
            url:webPath+"/svdm/risk/getListManagementDataDisplay",
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != ""){
                    var json = JSON.parse(data);
    ...
    function getIntegratedOperatingBehavior() {
        $.ajax({
            type: "POST",
            url:webPath+"/svdm/risk/getIntegratedOperatingBehavior",
            async: false,
            data:{unit_id:unit_id},
            success: function(data) {
                if(data != ""){
                    ...
                    for(var i=0;i<json.length;i++){
                        ...
                        temp.time=obj.RIQI;
                        temp.car_plate_number=obj.CHEPAIZHAOHAO;
                        temp.address=obj.DIZHI;
                        integratedOperating.push(temp);
                    }
                }
            }
        });
...
//			$("#msg").html(message+carCount+"。");
    ...
    function goBack() {
//        window.location.href=webPath+"/formpages/sheet2.jsp?unit_id="+unit_id;
        window.history.go(-1);
    }
</script>
<script>
...
<script>
    ...
    getUnitCarGpsList();
    getIntegratedOperatingBehavior();
